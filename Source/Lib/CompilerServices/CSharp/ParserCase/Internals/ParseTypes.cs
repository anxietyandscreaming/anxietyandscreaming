...
public static partial class Parser
{
    ...
    public static TypeClauseNode MatchTypeClause(ref CSharpParserState parserModel)
    {
        ...
        if (Parser.TryParseExpression(ref parserModel, out var expressionNode))
        {
    ...
    {
        Parser.HandleFunctionArguments(typeDefinitionNode, ref parserModel, variableKind: VariableKind.Property);
    }
