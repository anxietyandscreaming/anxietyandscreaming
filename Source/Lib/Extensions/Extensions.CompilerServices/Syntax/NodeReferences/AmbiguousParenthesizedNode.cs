...
public sealed class AmbiguousParenthesizedNode : IExpressionNode
{
    ...
    /// within the AmbiguousParenthesizedNode itself.
    ///
    /// We only want to look ahead just enough to determine if this is a
    /// - ParenthesizedExpressionNode
    /// - or should we continue as an AmbiguousParenthesizedNode
    ///
    ...
    /// I currently am transforming the AmbiguousParenthesizedNode
    ...
    /// go from ParenthesizedExpressionNode to AmbiguousParenthesizedNode
    ...
    public TypeReferenceValue ResultTypeReference => TypeFacts.Pseudo.ToTypeReference();
    ...
    ///
    /// How would one differentiate between an explicit cast node, and an AmbiguousParenthesizedNode.
    /// ````var x = 2;
    /// ````return (double)x;
    ///
    ...
    ///
    /// One would have to parse this as an 'AmbiguousParenthesizedNode'
    ...
    public int OffsetAmbiguousParenthesizedNodeChildList { get; set; }
    public int LengthAmbiguousParenthesizedNodeChildList { get; set; }
