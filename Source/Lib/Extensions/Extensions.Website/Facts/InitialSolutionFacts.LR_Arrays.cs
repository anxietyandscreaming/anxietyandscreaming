namespace Clair.Ide.Wasm.Facts;
...
public class ParseDefaultKeywords
{
    ...
    public static void HandleForeachTokenKeyword(ref CSharpParserState parserModel)
    {
        ...
        if ((enumerable.ResultTypeReference.ArrayRank == 1 || enumerable.ResultTypeReference.OffsetGenericParameterEntryList != -1) &&
            ...
            Clair.CompilerServices.CSharp.Facts.CSharpFacts.Types.Var.TypeIdentifierToken.TextSpan.CharIntSum == variableDeclarationNode.TypeReference.TypeIdentifierToken.TextSpan.CharIntSum &&
    ...
    public static void HandlePartialTypeDefinition(TypeDefinitionNode typeDefinitionNode, ref CSharpParserState parserModel)
    {
        ...
        if (typeDefinitionNode.IndexPartialTypeDefinition == -1)
        {
            ...
            var typeDefinitionMetadata = parserModel.Binder.TypeDefinitionTraitsList[typeDefinitionNode.TraitsIndex];
            typeDefinitionMetadata.IndexPartialTypeDefinition = typeDefinitionNode.IndexPartialTypeDefinition;
            parserModel.Binder.TypeDefinitionTraitsList[typeDefinitionNode.TraitsIndex] = typeDefinitionMetadata;
        }
        else
        {
