...
namespace Clair.Ide.RazorLib.Shareds.Displays.Internals;
...
//             I'm thinking that when publishing the Clair.Ide.Photino.csproj,
...
//             flag that was used to publish the 'Clair.Ide.Photino.csproj' project itself.
...
// ==========================================================================================================
//
// I ran the 'Clair.Ide.Photino.csproj' various ways while using the
...
// "Clair", and write out if that specific assembly has
// the debug attribute.
// 
