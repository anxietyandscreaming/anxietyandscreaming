...
public class StreamReaderPooledBuffer : TextReader
{
    ...
    public StreamReaderPooledBuffer(string path, Encoding encoding, byte[] byteBuffer, char[] charBuffer)
        : this(
            new FileStream(path, FileMode.Open, FileAccess.Read, FileShare.Read, DefaultFileStreamBufferSize),
            encoding,
            byteBuffer,
            charBuffer)
    {
