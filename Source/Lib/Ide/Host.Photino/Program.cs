...
class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        var hostingInformation = new ClairHostingInformation(
            ClairHostingKind.Photino,
            ClairPurposeKind.Ide);

        appBuilder.Services.AddClairIdeRazorLibServices(hostingInformation);
        appBuilder.Services.AddClairConfigServices(hostingInformation);
