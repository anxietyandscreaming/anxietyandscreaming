...
/// <summary>
/// Everytime one renders a unique <see cref="Clair.TextEditor.RazorLib.TextEditors.Displays.TextEditorViewModelSlimDisplay"/>,
...
{
    private readonly Throttle _throttleApplySyntaxHighlighting = new(TimeSpan.FromMilliseconds(1_500));
        ...
        TextEditorViewModelSlimDisplay textEditorViewModelSlimDisplay)
    {
        ...
        RowSectionElementId = $"ci_te_text-editor-body_{TextEditorHtmlElementId}";
        PrimaryCursorContentId = $"ci_te_text-editor-content_{TextEditorHtmlElementId}_primary-cursor";
        GutterElementId = $"ci_te_text-editor-gutter_{TextEditorHtmlElementId}";
        FindOverlayId = $"ci_te_find-overlay_{TextEditorHtmlElementId}";
    }
    ...
    // _ = "ci_te_text-editor-cursor " + BlinkAnimationCssClass + " " + _activeRenderBatch.Options.Keymap.GetCursorCssClassString();
    ...
    public TextEditorVirtualizationResult Virtualization { get; set; } = TextEditorVirtualizationResult.ConstructEmpty();
    ...
    public void SetWrapperCssAndStyle()
    {
        ...
        stringBuilder.Append("ci_te_text-editor ci_unselectable ci_te_text-editor-css-wrapper ");
        ...
        int fontSizeInPixels = options.CommonOptions.FontSizeInPixels;
        ...
        // string GetHeightCssStyle()
        {
                ...
                PreviousIncludeFooter != ViewModelDisplayOptions.FooterComponentType is not null)
            {
                ...
                if (ViewModelDisplayOptions.HeaderComponentType is not null)
                    stringBuilder.Append(" - var(--ci_te_text-editor-header-height)");
        
                if (ViewModelDisplayOptions.FooterComponentType is not null)
                    stringBuilder.Append(" - var(--ci_te_text-editor-footer-height)");
