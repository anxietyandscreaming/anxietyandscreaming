...
namespace Clair.TextEditor.RazorLib.Exceptions;
...
/// </remarks>
public class ClairTextEditorException : ClairException
{
    public ClairTextEditorException(string? message = null, Exception? innerException = null)
