...
public sealed class FindOverlayDecorationMapper : IDecorationMapper
{
    public string Map(byte decorationByte)
    {
        ...
        return decoration switch
        {
            ...
            FindOverlayDecorationKind.LongestCommonSubsequence => "background-color: var(--ci_te_diff-longest-common-subsequence-background-color);",
            FindOverlayDecorationKind.Insertion => "background-color: var(--ci_te_diff-insertion-background-color);",
            FindOverlayDecorationKind.Deletion => "background-color: var(--ci_te_diff-deletion-background-color);",
            FindOverlayDecorationKind.Modification => "background-color: var(--ci_te_diff-modification-background-color);",
            _ => string.Empty,
        };
    }
}
