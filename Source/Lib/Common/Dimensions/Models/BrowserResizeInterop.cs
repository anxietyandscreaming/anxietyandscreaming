...
public class BrowserResizeInterop
{
    ...
    public async Task SubscribeWindowSizeChanged(ClairCommonJavaScriptInteropApi clairCommonJavaScriptInteropApi)
    {
        ...
        _commonService.SetAppDimensions_Silent_NoEventRaised(await clairCommonJavaScriptInteropApi.SubscribeWindowSizeChanged(
            _browserResizeInteropDotNetObjectReference,
            CommonFacts.RootHtmlElementId));
    }
    
    public void DisposeWindowSizeChanged(ClairCommonJavaScriptInteropApi clairCommonJavaScriptInteropApi)
    {
        clairCommonJavaScriptInteropApi.DisposeWindowSizeChanged();
    }
}
