...
/// </remarks>
public static class ClairCommonJsRuntimeExtensionMethods
{
    public static ClairCommonJavaScriptInteropApi GetClairCommonApi(this IJSRuntime jsRuntime)
    {
        return new ClairCommonJavaScriptInteropApi(jsRuntime);
    }
}
